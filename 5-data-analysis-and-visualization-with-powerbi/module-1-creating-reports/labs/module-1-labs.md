...
* **Payment Insights:** Built a **Pie Chart** to show the distribution of *Order Total* by *Payment Method*, identifying the most popular transaction types.
* **Trend Tracking:** Implemented a **Line Chart** plotting *Order Total* against *Order Date* to reveal sales patterns and cycles over time.
